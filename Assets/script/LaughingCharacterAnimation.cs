...
//public class LaughingCharacterAnimation : MonoBehaviour
//{
//    public Animator animator;               // Animator du personnage
//    public float appearAfter = 600f;        // Par exemple, il apparaît après 2 minutes (à ajuster)
//    public float disappearAfter = 650f;     // 3 minutes après l'apparition
...
public class LaughingCharacterAnimation : MonoBehaviour
{
    ...
    public float appearAfter = 450f;
    public float disappearAfter = 500f;
