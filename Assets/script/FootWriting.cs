...
public class FootWriting : MonoBehaviour
{
    public float firstAppearTime = 150f;      // Apparition 1
    public float firstDisappearTime = 500f;  // Disparition 1
    public float secondAppearTime = 530f;    // Apparition 2
