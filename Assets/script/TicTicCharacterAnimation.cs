...
public class TicTicCharacterAnimation : MonoBehaviour
{
    public Animator animator;                  // Animator du personnage
    public float appearAfter = 180f;           // Temps avant la première apparition (en secondes)
    public float repeatInterval = 120f;        // Intervalle entre chaque répétition (5 min)
