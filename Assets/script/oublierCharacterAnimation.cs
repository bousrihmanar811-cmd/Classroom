...
//public class oublierCharacterAnimation : MonoBehaviour
//{
//    public Animator animator;               // Animator du personnage
//    public float appearAfter = 910f;        // Par exemple, il apparaît après 2 minutes (à ajuster)
//    public float disappearAfter = 920f;     // 3 minutes après l'apparition
...
public class oublierCharacterAnimation : MonoBehaviour
{
    ...
    public float appearAfter = 580f;
    public float disappearAfter = 590f;
    ...
    void AppearAndAnimate()
    {
        ...
        // Correction : durée = disappearAfter - appearAfter
